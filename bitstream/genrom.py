#!/usr/bin/env python3
# usage: genrom.py input1.bit input2.bit ... > rom.c
# heatshrink-compresses each bitstream and emits it as a C array.
# needs the heatshrink CLI (make -C heatshrink heatshrink), or set HEATSHRINK.

import sys
import os
import subprocess

# must match HEATSHRINK_STATIC_WINDOW_BITS / LOOKAHEAD_BITS in the firmware
WINDOW_BITS = 8
LOOKAHEAD_BITS = 4
